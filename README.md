...
A premium, **cinematic single-page web invitation** designed for the Civil Engineering batch farewell — *Mistree Furwell*. Built with a modern architectural aesthetic featuring deep slate backgrounds, metallic gold accents, glassmorphism UI cards, live countdown timer, floating particle effects, and an interactive scroll-to-play video core. just made by Rudranshu with Civil department. will make another one next year.
...
| Feature | Description |
|---|---|
| 🎥 **Scroll-to-Play Video** | Uses `IntersectionObserver` API to auto-play the farewell video when scrolled into view |
| 🔊 **Interactive Unmute Overlay** | Elegant tap-to-enter screen bypasses browser autoplay restrictions |
| ⏳ **Live Countdown Timer** | Real-time countdown to the event (14th May 2026, 3:30 PM IST) |
| ✨ **Gold Particle Sparkles** | Canvas-based floating gold particle animation for a cinematic atmosphere |
| 📊 **Scroll Progress Bar** | Glowing gold progress indicator at the top of the page |
| 🔼 **Back to Top Button** | Smooth-scroll floating button that appears after scrolling 300px |
| 🔗 **Share the Invitation** | One-click copy-to-clipboard link sharing for guests |
...
- **Event:** Smriti 5.0 — *Mistree Furwell*
- **Date:** 14th May, 2026
- **Time:** 3:30 PM IST
- **Venue:** Seminar Hall
- **Dress Code:** Formal Attire (Black & Gold preferred)
- **Host:** Department of Civil Engineering — 2nd Years
...
```bash
git clone https://github.com/AryanAKE/smriti-5.0.git
cd smriti-5.0
...
├── Farewell 3.mp4    # The farewell video invitation (via Git LFS)
└── README.md         # This file
```
...
- **Git LFS** — Large video file storage
...
- **Produced by:** Civil Engineering 2nd Years
- **Event:** Smriti 5.0 — Civil Engineering Farewell 2026
